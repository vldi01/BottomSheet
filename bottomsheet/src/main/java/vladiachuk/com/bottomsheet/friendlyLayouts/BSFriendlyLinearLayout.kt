...
class BSFriendlyLinearLayout : LinearLayout {
    ...
    fun setupAttributes() {
        ...
        val arr = context.obtainStyledAttributes(attrs, R.styleable.BSFriendlyLinearLayout, 0, 0)

        if (arr.hasValue(R.styleable.BSFriendlyLinearLayout_bottom_sheet_id)) {
            id = arr.getResourceId(R.styleable.BSFriendlyLinearLayout_bottom_sheet_id, 0)
        }
